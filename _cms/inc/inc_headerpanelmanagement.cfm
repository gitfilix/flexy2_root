...
<!--- 	BEI JEDEM Binary fileupload muss im Formular multipart/form-data als enctype mitgegeben werden.  --->
	...
	<tr>
		...
		<input type="submit" value="Headerpanel erfassen"> <input type="button" value="abbrechen" onclick="location.href='#cgi.SCRIPT_NAME#';"></td>
	</tr>
	</table>
	</form>
...
<cfoutput query="editHeaderpanel">
	...
	<tr>
		...
		<td>
			...
			<input type="hidden" name="headerpanelsid" value="#id#" />
			<input type="submit" value="Headerpanel ändern"> <input type="button" value="abbrechen" onclick="location.href='#cgi.SCRIPT_NAME#';">
		</td>
	</tr>
	</table>
	</form>
