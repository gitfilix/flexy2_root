...
<tr>
	<td colspan="76">
		<div style="display:none;background-color:##e1e1e1;" id="bilderMulti#albumIDx#">
...
<tr>
	<td colspan="7">
		<div style="<cfif isdefined("url.openGallery") AND url.openGallery EQ getAlbums.id>display:block;<cfelse>display:none;</cfif>background-color:##e1e1e1;" id="bilder#albumIDx#">
