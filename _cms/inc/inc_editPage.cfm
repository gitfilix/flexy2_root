...
<cfoutput query="editPage">
	...
	<tr>
		<td>Status <div style="float:right;">#flexyLib.setHelpText(variable='editPage_status',type=3,visualType=4)#</div></td>
		<td>
	...
	<cfif mandantenfeldfreigaben.recordcount EQ 1 AND mandantenfeldfreigaben.fieldState EQ 1>
	<tr>
		<td>Trägerseite <div style="float:right;">#flexyLib.setHelpText(variable='editPage_parentPage',type=3,visualType=3)#</div></td>
		<td>
			<!--- <cfset t = parentid />
