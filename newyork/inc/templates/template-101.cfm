...
<cfoutput>
	<div style="height:100%;background:##000;position:relative;">
		...
		<div class="animatedBackground anim" data-inanimation="0-fadeIn-1" style="height:100%;background:url(/newyork/upload/magazine/ny00.jpg) center center no-repeat;background-size:cover;z-index:1;position:absolute;width:100%;">&nbsp;</div>
		<div class="anim"                   data-inanimation="10-fadeIn-2" data-outanimation="15-fadeOut-0.5" style="height:100%;background:url(/newyork/upload/magazine/ny-bg1.jpg) center center no-repeat;background-size:cover;z-index:2;position:absolute;width:100%;">&nbsp;</div>
		<div class="animatedBackground anim" data-inanimation="15-fadeIn-2" data-outanimation="25-fadeOut-0.5" style="height:100%;background:url(/newyork/upload/magazine/ny02.jpg) center center no-repeat;background-size:cover;z-index:3;position:absolute;width:100%;">&nbsp;</div>
		<div class=" anim"                   data-inanimation="30-fadeIn-2" data-outanimation="35-fadeOut-0.5" style="height:100%;background:url(/newyork/upload/magazine/ny-bg2.jpg) center center no-repeat;background-size:cover;z-index:4;position:absolute;width:100%;">&nbsp;</div>
		<div class="animatedBackground anim" data-inanimation="35-fadeIn-2" data-outanimation="45-fadeOut-0.5" style="height:100%;background:url(/newyork/upload/magazine/ny04.jpg) center center no-repeat;background-size:cover;z-index:5;position:absolute;width:100%;">&nbsp;</div>
		<div class="animatedBackground anim" data-inanimation="45-fadeIn-2" data-outanimation="55-fadeOut-0.5" style="height:100%;background:url(/newyork/upload/magazine/ny05.jpg) center center no-repeat;background-size:cover;z-index:6;position:absolute;width:100%;">&nbsp;</div>
		<div class="animatedBackground anim" data-inanimation="55-fadeIn-2" data-outanimation="65-fadeOut-0.5" style="height:100%;background:url(/newyork/upload/magazine/ny06.jpg) center center no-repeat;background-size:cover;z-index:7;position:absolute;width:100%;">&nbsp;</div>
		<div class="animatedBackground anim" data-inanimation="65-fadeIn-2" data-outanimation="75-fadeOut-0.5" style="height:100%;background:url(/newyork/upload/magazine/ny07.jpg) center center no-repeat;background-size:cover;z-index:8;position:absolute;width:100%;">&nbsp;</div>
		...
		<cfswitch expression="#getSlideContent.layout#">
			...
			<cfcase value="4">
				<audio src="/newyork/upload/mp3/shaft.mp3" autoplay style="position:absolute;left:9999px;"></audio>
				...
				<div style="width:50%;background:rgba(255,156,0,0.7);height:50%;position:absolute !important;left:0;bottom:0;z-index:100;" class="anim" data-inanimation="3.2-slideInLeft-0.5" data-outanimation="9-slideOutLeft-0.5">
				...
				<!--- <div class="anim" data-inanimation="5.2-slideInLeft-0.5" data-outanimation="10-slideOutLeft-0.5"  style="height:100%;" >
				<img src="/newyork/img/zebra_blue.gif">
				</div> --->
				...
				<div style="width:50%;background:rgba(255,156,0,0.7);height:50%;position:absolute !important;left:0;bottom:0;z-index:100;" class="anim" data-inanimation="17-slideInLeft-0.5" data-outanimation="23-slideOutLeft-0.5">
					<div style="position:absolute;top:1em;" class="anim center" data-inanimation="18-scaleTextUp-0.3" data-outanimation="22-fadeOut-0.5">
						<h2 style="text-align:center; font-size:7em;  font-family:'league gothic';color:##162942;">These vagabond shoes</h2>
					</div>
				</div>
				...
				<div style="width:50%;background:rgba(7,26,51,0.7);height:50%;position:absolute !important;right:-50%;bottom:0;z-index:100;" class="anim" data-inanimation="24-slideInBottom-0.5" data-outanimation="28-slideOutLeft-0.5">
					<div style="position:absolute;top:1em;" class="anim center" data-inanimation="25-scaleTextUp-0.3">
						<h2 style="text-align:center; font-size:7em; font-family:'league gothic'; color:white;">Right through the<br/>very heart of it</h2>
					</div>
				</div>
				...
				<div style="width:50%;background:rgba(7,26,51,0.7);height:50%;position:absolute !important;right:-50%;bottom:0;z-index:100;" class="anim" data-inanimation="36.5-slideInBottom-0.5" data-outanimation="41-slideOutLeft-0.5">
					<div style="position:absolute;top:1em;" class="anim center" data-inanimation="37-scaleTextUp-0.3">
						<h2 style="text-align:center; font-size:8em; font-family:'league gothic'; color:white;">That doesn't sleep</h2>
					</div>
				</div>
				...
				<div style="width:50%;background:rgba(7,26,51,0.7);height:50%;position:absolute !important;right:-50%;bottom:0;z-index:100;" class="anim" data-inanimation="44-slideInBottom-0.5" data-outanimation="50-slideOutLeft-0.5">
					<div style="position:absolute;top:1em;" class="anim center" data-inanimation="45.5-scaleTextUp-0.3">
						<h2 style="text-align:center; font-size:8em; font-family:'league gothic'; color:white;">Top of the heap</h2>
					</div>
				</div>
				...
				<div style="width:50%;background:rgba(255,156,0,0.7);height:50%;position:absolute !important;left:0;top:0;z-index:100;" class="anim" data-inanimation="52-slideInTop-0.5" data-outanimation="57-slideOutRight-0.5">
					<div style="position:absolute;top:1em;" class="anim center" data-inanimation="53-scaleTextUp-0.6">
						<h2 style="text-align:center; font-size:10em;  font-family:'league gothic'; color:white;">Come To<br>New York</h2>
					</div>
				</div>
				...
				<div style="width:50%;background:rgba(255,156,0,0.7);height:50%;position:absolute !important;left:0;top:0;z-index:100;" class="anim" data-inanimation="57-slideInTop-0.5" data-outanimation="62-slideOutTop-0.5">
					<div style="position:absolute;top:1em;" class="anim center" data-inanimation="58-scaleTextUp-0.3">
						<h2 style="text-align:center; font-size:8em; font-family:'league gothic'; color:white;">If I can make it there</h2>
					</div>
				</div>	
				<div style="width:50%;background:rgba(255,156,0,0.7);height:50%;position:absolute !important;right:-50%;bottom:0;z-index:100;" class="anim" data-inanimation="57-slideInBottom-0.5" data-outanimation="62-slideOutBottom-0.5">
					<div style="position:absolute;bottom:1em;" class="anim center" data-inanimation="58.5-scaleTextUp-0.3">
						<h1 style="text-align:center; font-size:7em; font-family:'league gothic'; color:##162942">I'll make it anywhere</h1>
					</div>					
				</div>
				
				<div style="width:50%;background:rgba(255,156,0,0.7);height:50%;position:absolute !important;right:0;bottom:0;z-index:100;" class="anim" data-inanimation="63-slideInLeft-0.5" data-outanimation="68-slideOutLeft-0.5">
				...
				<!--- button  --->
				<div style="width:50%;background:rgba(255,156,0,0.7);height:50%;position:absolute !important;left:0;top:0;z-index:100;" class="anim" data-inanimation="72-slideInTop-0.5" >
					<div style="position:absolute;top:1em;" class="anim center" data-inanimation="73-scaleTextUp-0.3">
						<h2 style="text-align:center; font-size:10em;  font-family:'league gothic'; color:##162942;">Come To<br>New York</h2>
					</div>
				</div>
				<div style="width:50%;background:rgba(7,26,51,0.7);height:50%;position:absolute !important;right:-50%;bottom:0;z-index:100;" class="anim" data-inanimation="73-slideInBottom-0.5" >
					<div style="position:absolute;top:1em;" class="anim center" data-inanimation="74.5-scaleTextUp-0.6">
						<h2 style="text-align:center; font-size:10em; font-family:'league gothic'; color:##FFF;">Fly To<br>New York</h2>
					</div>
				</div>
