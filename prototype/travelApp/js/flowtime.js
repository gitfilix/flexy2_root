...
*/
	...
	function navigateTo(dest, push, linked)
	{
		...
		/* mirza, 9/10/2013 */
		x = NavigationMatrix.getCurrentPage();
		...
		v = NavigationMatrix.getPageIndex(f)
		z = NavigationMatrix.getPageIndex(NavigationMatrix.getPrevPage())
		/* ENDE MIRZA */
...
*/
	...
	function onKeyUp(e)
	{
		...
		if (tag != "INPUT" && tag != "TEXTAREA" && tag != "SELECT" && $('#lightbox').css('display')=='none')
		{
			e.preventDefault();
			switch (e.keyCode)
			{
