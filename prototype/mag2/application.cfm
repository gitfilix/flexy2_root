...
<cfapplication name="#replace(dirName,'-','','ALL')#" sessionmanagement="yes" sessiontimeout="#createTimeSpan(0,0,20,0)#" setclientcookies="yes" scriptprotect="yes">
...
<!--- init magazine cfc --->
<cfset fs = createObject('component','prototype.mag2.cfc.futurescreen') />
