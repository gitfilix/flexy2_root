...
<!--- ServiceNav content for NON- Acordeon content --->
<cfquery name="getServiceContent" datasource="#application.dsn#">
	SELECT 	* FROM content
...
<head>
	...
	<title>TSM-15 Crossmedia Blog by Webkanal</title>
	...
	<link rel='stylesheet' href='/#session.serverpath#/css/blog-style.css' type='text/css'>
