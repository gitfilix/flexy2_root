...
<div>
	<cfoutput>		
			<img src="/#session.serverpath#/img/logo-fx-blue3.jpg" alt="hi" id="formimg" />
	</cfoutput>
	<cfoutput>
	<div class="webform">
		<h2>Get Contact</h2>
	<!--- contactreceaver is #CONTACTRECIEVER# --->
		...
		<ul> 
			...
			<li style="float:right;">
			 ...
			 <li class="push">
                ...
                <input type="submit" class="btn" id="submit-btn" name="Kontaktsenden" value="Kontakt mit FLX Pix" />
