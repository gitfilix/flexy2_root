...
<cfif isDefined("form.albumList")>
	...
	<!---<cfloop list="#form.fieldnames#" index="i">
		<cfif i EQ "bilder">
			<cffile action="uploadAll" filefield="bilder" destination="#expandPath('/spa/upload/galleries')#" nameconflict="makeunique"> 
		<cfelse>
...
<cfquery name="spaApiTeaser" datasource="atelier_schief_ch">
	SELECT 	* 
	FROM 	sidebar
	WHERE	Mandant =  76
