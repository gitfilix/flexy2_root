...
<!--- Galerie mit css template2 photogallery verbessert - keine funktionalen anderungen --->
...
<!--- 			<div  class="gallery_pix" style="height:80px;width:80px;background-color:##e1e1e1;overflow:hidden;float:left;margin-right:1.5em;text-align:center;"> --->	
		<div  class="gallery_pix" >
			...
			<!--- 	<cfif bildformat EQ "hoch">style="height:80px;"
					<cfelse>style="width:80px;"
				</cfif> --->
			</a>
		</div>
